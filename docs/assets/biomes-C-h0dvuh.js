import{b as u,g as h,d as m,e as g}from"./biomeWildlife-mBoYh2ch.js";const d=document.getElementById("biomeSelector"),a=document.getElementById("biomeDisplay"),l=document.getElementById("biomeDescription"),c=document.getElementById("biomeImage");if(!d||!a||!l||!c)throw new Error("Biome explorer markup is missing expected elements.");const n=d,r=a,i=l,s=c;u.forEach(t=>{const o=document.createElement("option");o.value=t.id,o.textContent=t.name,n.appendChild(o)});function b(t=[]){return!Array.isArray(t)||t.length===0?"None":t.join(", ")}function p(t=[]){return t.length?`
