 ...
 */
export function xorshift128plus(seed0, seed1) {
 ...
 * s1 = (lane2 << 32) | lane3
 */
export function fromCanonicalSeed(seed) {
    const to64 = (hi, lo) => ((BigInt(hi >>> 0) << 32n) | BigInt(lo >>> 0)) & ((1n << 64n) - 1n);
